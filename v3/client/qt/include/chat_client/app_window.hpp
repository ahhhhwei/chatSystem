...
private:
    ...
    QWidget* build_window_title_bar();
    ...
    static QIcon group_avatar_icon(
    ...
    QHash<QString, QIcon> group_avatars_;
    QSet<QString> group_avatar_requests_;

    QWidget* window_title_bar_ = nullptr;
    QPoint window_drag_offset_;
